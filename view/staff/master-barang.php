                                                            ...
                                                            ?>
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="nama_barang" class="form-control" id="namabarang" value="<?= htmlspecialchars($row['nama_barang']); ?>" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="stok">Stok</label>
                                                                        <input type="number" name="stok" class="form-control" id="stok" value="<?= $row['stok']; ?>" required min="0">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="harga" class="form-control" id="harga" value="<?= $row['harga']; ?>" required min="0">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="nama-suplier">Nama Suplier</label>
                                                                        <select name="id_suplier" id="nama-suplier" class="custom-select" required>
                                                                            <?php
                ...
                <div class="modal-body">
                    ...
                    <form role="form" method="POST" action="query/add-barang.php">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="kodebarang">Kode Barang</label>
                                <input type="text" name="kode_barang" class="form-control" id="kodebarang" placeholder="Kode Barang" required>
                            </div>
                            <div class="form-group">
                                <label for="namabarang">Nama Barang</label>
                                <input type="text" name="nama_barang" class="form-control" id="namabarang" placeholder="Nama Barang" required>
                            </div>
                            <div class="form-group">
                                <label for="stok">Stok</label>
                                <input type="number" name="stok" class="form-control" id="stok" placeholder="Stok" required min="0">
                            </div>
                            <div class="form-group">
                                <label for="harga">Harga</label>
                                <div class="input-group-prepend">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="harga" class="form-control" id="harga" placeholder="Harga" required min="0">
